    ...
    <div ref={root} className="site-shell">
      ...
      <main>
        <section className="hero" id="inicio">
          ...
          <picture className="hero-picture"><source media="(max-width: 900px)" srcSet="/hero-mobile-real.jpg"/><img className="hero-people" src="/hero-desktop.png" alt="Marcelo Barros e Natália Mesquita em ambiente profissional" /></picture>
